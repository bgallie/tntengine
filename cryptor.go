...
var (
	...
	Rotor1 = new(Rotor).New(1789, 1065, 1499, []byte{
		...
		63, 105, 179, 29, 90, 37, 123, 92, 184, 190, 60, 21, 108, 52, 36, 210})
	...
	Rotor2 = new(Rotor).New(1787, 1624, 249, []byte{
		...
		20, 223, 130, 220, 205, 71, 23, 249, 38, 155, 36, 251, 111, 140, 9, 139,
		138, 227, 238, 86, 154, 45, 125, 197, 223, 97, 123, 12, 227, 75, 167, 55})
	...
	Rotor3 = new(Rotor).New(1783, 1056, 1256, []byte{
		...
		123, 146, 74, 136, 109, 83, 79, 23, 0, 217, 108, 66, 4, 232, 135, 170,
		41, 250, 53, 123, 114, 6, 189, 89, 179, 209, 173, 110, 252, 29, 95, 105,
		59, 255, 92, 230, 125, 26, 74, 117, 109, 173, 71, 131, 109, 170, 138})
	...
	Rotor4 = new(Rotor).New(1777, 210, 241, []byte{
		...
		92, 173, 117, 228, 93, 41, 58, 60, 117, 73, 202, 213, 245, 102, 130, 59,
		167, 110, 146, 183, 179, 128, 181, 82, 68, 96, 1, 54, 27, 62, 214, 18,
		24, 159, 21, 84, 250, 43, 55, 5, 41, 75, 251, 166, 169, 151, 251})
	...
	Rotor5 = new(Rotor).New(1759, 955, 1559, []byte{
		...
		1, 178, 204, 34, 207, 248, 237, 125, 97, 84, 171, 1, 63, 175, 194, 29,
		135, 7, 100, 12, 10, 93, 23, 37, 57, 62, 242, 61, 34, 3, 0, 236,
		143, 192, 21, 133, 147, 153, 30, 71, 26, 206, 133, 230})
	...
	Rotor6 = new(Rotor).New(1753, 370, 362, []byte{
		...
		167, 248, 169, 252, 209, 201, 18, 16, 98, 245, 152, 173, 196, 78, 172, 102,
		157, 83, 61, 131, 40, 35, 75, 86, 157, 19, 161, 192, 6, 114, 51, 100,
		125, 187, 12, 175, 242, 18, 184, 245, 121, 9, 237, 89})

	Permutator1 = new(Permutator).New([]int{256}, []byte{
...
type Crypter interface {
	...
	SetIndex(*big.Int)
	Index() *big.Int
	ApplyF(*[CipherBlockBytes]byte) *[CipherBlockBytes]byte
	ApplyG(*[CipherBlockBytes]byte) *[CipherBlockBytes]byte
}
